...
export default function SavedJobsPage() {
  return (
    <div className="mx-auto mt-16 max-w-3xl px-4 text-center sm:px-6">
      <h1 className="text-3xl font-bold text-slate-900">Saved Jobs Removed</h1>
      <p className="mt-3 text-slate-600">
        This simplified version includes Firebase Google login and Firecrawl-powered job search only.
      </p>
      <Link
        href="/"
